...
const INDEX: SearchItem[] = [
  ...
  { id: "tb-002", category: "thongbao", title: "Thông báo về lịch học các lớp buổi tối",            description: "Các lớp học buổi tối điều chỉnh lịch theo quyết định của Ban Giám hiệu. Sinh viên chú ý cập nhật lại thời khóa biểu.", meta: "24/03/2020", href: "/thong-tin/thong-bao" },
  ...
  /* ── Thời khóa biểu ── */
  { id: "tkb-001", category: "tkb", title: "Lịch học các lớp Anh văn 2026",         description: "Thời khóa biểu chính thức các lớp Anh văn học kỳ 1 năm 2026. Bao gồm lịch học lý thuyết và thực hành.", meta: "12/10/2024", href: "/thong-tin/thoi-khoa-bieu" },
  { id: "tkb-002", category: "tkb", title: "Lịch học lớp IELTS Intermediate – K12",  description: "Thời khóa biểu lớp IELTS Intermediate dành cho sinh viên khóa 12, học từ tháng 10/2024.", meta: "10/10/2024", href: "/thong-tin/thoi-khoa-bieu" },
  { id: "tkb-003", category: "tkb", title: "Lịch học lớp IELTS Intermediate – K13",  description: "Thời khóa biểu lớp IELTS Intermediate dành cho sinh viên khóa 13, bắt đầu từ tháng 10/2024.", meta: "10/10/2024", href: "/thong-tin/thoi-khoa-bieu" },
  { id: "tkb-004", category: "tkb", title: "Lịch học các lớp TOEIC 650+ Online",     description: "Lịch học trực tuyến các lớp TOEIC mục tiêu 650+ kỳ 2 năm 2024. Học viên đăng nhập hệ thống LMS để tham gia.", meta: "05/10/2024", href: "/thong-tin/thoi-khoa-bieu" },
  { id: "tkb-005", category: "tkb", title: "Thời khóa biểu Giáo dục thể chất – HK1", description: "Lịch học Giáo dục thể chất học kỳ 1 năm học 2024–2025. Sinh viên kiểm tra phòng và ca học theo nhóm.", meta: "08/10/2024", href: "/thong-tin/thoi-khoa-bieu" },

  /* ── Hướng dẫn ── */
  { id: "hd-001", category: "huongdan", title: "Hướng dẫn đăng ký học phần chuẩn đầu ra", description: "Quy trình đăng ký các học phần bắt buộc về chuẩn đầu ra ngoại ngữ và tin học. Hướng dẫn từng bước trên hệ thống đăng ký học phần.", meta: "Cập nhật 2024", href: "/huong-dan-dang-ky" },
  { id: "hd-002", category: "huongdan", title: "Điều kiện dự thi và miễn thi chuẩn đầu ra",   description: "Các điều kiện để sinh viên được đăng ký dự thi hoặc được xét miễn thi chuẩn đầu ra theo quy định của Trường.", meta: "Cập nhật 2024", href: "/huong-dan-dang-ky" },
  { id: "hd-003", category: "huongdan", title: "Hướng dẫn nộp chứng chỉ ngoại ngữ thay thế",  description: "Sinh viên có chứng chỉ IELTS, TOEIC, VSTEP hoặc tương đương có thể nộp thay thế kỳ thi chuẩn đầu ra theo quy định.", meta: "Cập nhật 2024", href: "/huong-dan-dang-ky" },

  /* ── VSTEP ── */
  { id: "vs-001", category: "vstep", title: "Lịch thi VSTEP tháng 12/2024",    description: "Lịch kiểm tra VSTEP (Vietnamese Standardized Test of English Proficiency) đợt tháng 12. Địa điểm tổ chức tại Trường Đại học Nam Cần Thơ.", meta: "Tháng 12/2024", href: "https://vstep.nctu.edu.vn/lich-thi/" },
  { id: "vs-002", category: "vstep", title: "Kế hoạch thi VSTEP năm 2025",      description: "Kế hoạch tổ chức các đợt thi VSTEP trong năm 2025. Sinh viên tham khảo để chủ động đăng ký theo tiến độ học tập.", meta: "Năm 2025",     href: "https://vstep.nctu.edu.vn/ke-hoach-nam/" },
  { id: "vs-003", category: "vstep", title: "Thông báo VSTEP – Điều chỉnh lịch", description: "Trung tâm VSTEP thông báo điều chỉnh lịch thi một số đợt do sắp xếp phòng thi. Thí sinh kiểm tra lại thông tin đăng ký.", meta: "10/2024",       href: "https://vstep.nctu.edu.vn/thong-bao-vstep/" },
];
    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          {item.badge && (
            <span className={`rounded-full px-2.5 py-0.5 text-[11px] font-bold ring-1 ${badgeCls}`}>
              {item.badge}
            </span>
          )}
        ...
        {/* Title */}
        <h3 className="text-[15px] font-bold leading-snug text-slate-900 group-hover:text-[#ED1F25] transition-colors sm:text-[16px]">
          {highlight(item.title, query)}
        </h3>

        {/* Description */}
        <p className="text-[13px] leading-relaxed text-slate-500 line-clamp-2 sm:text-[14px]">
...
export default function SearchPage() {
  ...
  const allResults  = search(submitted);
      ...
      <AnimatePresence>
        {!hasSearched && (
          ...
          >
            ...
            >
              {/* <div
                className="mb-2 flex h-14 w-14 items-center justify-center rounded-2xl shadow-sm"
                style={{ background: "#ED1F25" }}
              >
                <i className="bi bi-search text-[24px] text-white" />
              </div> */}
              <h1
              ...
              {/* <p className="text-[14px] text-slate-400">
                Tra cứu thí sinh, kết quả thi, lịch học và thông báo
              </p> */}
            </motion.div>
            ...
            >
              <form
                ...
                className="group flex items-center gap-3 rounded-full bg-white px-6 py-4 shadow-[0_2px_24px_rgba(15,23,42,0.10)] ring-1 ring-slate-200 transition-all duration-200 focus-within:shadow-[0_4px_32px_rgba(15,23,42,0.14)] focus-within:ring-slate-300"
              >
                <i className="bi bi-search text-[18px] text-slate-400 shrink-0" />
                <input
                  ref={inputRef}
                  type="text"
                  value={query}
                ...
                {query && (
                  <button
                    type="button"
                    onClick={() => setQuery("")}
                    className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full text-slate-400 hover:bg-slate-100 hover:text-slate-600 transition-colors"
                  >
                ...
                <button
                  type="submit"
                  disabled={!query.trim()}
                  className="shrink-0 rounded-full bg-[#ED1F25] px-5 py-2 text-[13px] font-semibold text-white transition-all hover:bg-red-700 disabled:opacity-40 disabled:cursor-not-allowed"
                >
                  Tìm
                </button>
              </form>
      ...
      <AnimatePresence>
        {hasSearched && (
          ...
          >
            ...
            <div className="sticky top-[80px] z-40 border-b border-slate-200/70 bg-white/95 backdrop-blur-md">
              <div className="container mx-auto flex items-center gap-3 px-4 py-3 sm:py-4">
                ...
                >
                  <i className="bi bi-search text-[16px] text-slate-400 shrink-0" />
                  <input
                    ref={compactRef}
                    type="text"
                    value={query}
                  ...
                  {query && (
                    <button
                      type="button"
                      onClick={clearSearch}
                      className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full text-slate-400 hover:bg-slate-200 transition-colors"
                    >
              ...
              <div className="mx-auto max-w-3xl">
                ...
                {results.length > 0 ? (
                  <div className="flex flex-col gap-3">
                    {results.map((item, i) => (
                      <ResultCard key={item.id} item={item} query={submitted} index={i} />
                    ))}
                  </div>
                ) : (
                  <motion.div
                    ...
                    <div className="flex flex-wrap justify-center gap-2">
                      {SUGGESTIONS.map((s) => (
                        <button
                          ...
                          className="rounded-full border border-slate-200 px-3 py-1 text-[13px] text-slate-500 hover:border-red-300 hover:text-red-600 transition-colors"
                        >
                          {s}
                        </button>
                      ))}
