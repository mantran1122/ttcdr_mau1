...
import { NEWS_CATEGORY_LABEL } from "@/data/newsPosts";
    ...
    <section className="pb-24 lg:pb-32">
      ...
      <div className="container mx-auto mb-8 px-4 pt-2 sm:mb-10 sm:px-6 sm:pt-4 lg:mb-12 lg:px-8 lg:pt-6">
        ...
        >
          ...
          <span className="line-clamp-1 text-slate-600">{NEWS_CATEGORY_LABEL[post.category]}</span>
        </motion.div>
        ...
        <section className="mt-14 border-t border-slate-200/80 pt-12 sm:mt-16 sm:pt-14">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <motion.div
              ...
              transition={{ duration: 0.5, ease: EASE }}
            >
              <h2 className="mb-6 text-2xl font-bold text-slate-900">Tin tức liên quan</h2>
                      ...
                      <div className="p-4">
                        <div className="mb-1.5 flex items-center gap-2 text-xs">
                          <span className="font-medium text-red-600">
                            {NEWS_CATEGORY_LABEL[rp.category]}
                          </span>
