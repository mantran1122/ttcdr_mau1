  ...
  return (
    <section className="relative isolate overflow-hidden py-24 xl:py-28">
      ...
      {/* <motion.div
        ...
        className="absolute left-1/2 top-1/2 -z-10 h-[920px] w-[920px] -translate-x-1/2 -translate-y-1/2 rounded-full border border-slate-300"
      />
      <motion.div
        ...
        className="absolute left-1/2 top-1/2 -z-10 h-[700px] w-[700px] -translate-x-1/2 -translate-y-1/2 rounded-full border border-slate-300"
      />
      <motion.div
